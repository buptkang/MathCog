...
namespace starPadSDK.MathExpr
{
    ...
    public class BuiltInEngine : Engine
    {
        ...
        public WKSID head(Expr e) { return (e is CompositeExpr) && (e as CompositeExpr).Head is WellKnownSym ? ((e as CompositeExpr).Head as WellKnownSym).ID : WellKnownSym.none.ID; }
        public Expr[] Args(Expr e) { return (e is CompositeExpr) ? (e as CompositeExpr).Args : null; }
